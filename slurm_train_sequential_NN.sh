...
#SBATCH -J PhiSequentialModel 

### (Optional)
### If you'd like to give a bit more information about your job, you can
### use the command below.
#SBATCH --comment='Training a naive NN on series GloVe embeddings for NNs'
...
#SBATCH -o /home/pkinne2/cluster-logs/NN/file-%A.out
#SBATCH -e /home/pkinne2/cluster-logs/NN/file-%A.err
...
hostname
scl enable rh-python36 "python train_on_GloVe_timeseries.py"
